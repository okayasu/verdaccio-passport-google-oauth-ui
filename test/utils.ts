...
export function createTestVerdaccioConfig(
  verdaccioConfig: Partial<VerdaccioGoogleOAuthConfig> = {},
  pluginConfig: Partial<PluginConfig> = {},
) {
  return {
    auth: {
...
export function createTestVerdaccio(
  config: Partial<VerdaccioGoogleOAuthConfig> = {},
) {
...
export function createTestAuthCore(config: Partial<VerdaccioGoogleOAuthConfig> = {}) {
  return new AuthCore(
...
export function createTestPlugin(config: Partial<VerdaccioGoogleOAuthConfig> = {}) {
